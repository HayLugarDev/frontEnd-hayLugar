<template>
    ...
    <div class="min-h-screen bg-gradient-to-br from-[#0D1B2A] via-[#1B263B] to-[#0D1B2A] md:px-6 md:py-10 text-white">

        <section
            class="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl shadow-xl p-6 md:p-10 max-w-3xl mx-auto">
            <!-- Título -->
                 ...
                 hover:bg-white/10 transition-all cursor-pointer flex flex-col gap-4">
                    ...
                    <div class="flex justify-end flex-wrap gap-2 mt-1">
                        ...
                        <button v-if="notification.reservation_role === 'client'" @click="goToReservations"
                            class="px-4 py-2 bg-[#00B4D8] text-white text-sm rounded-lg font-semibold shadow hover:bg-[#06D6A0] transition active:scale-95">
                            Ir a reserva
                        </button>
                    </div>
                </li>
