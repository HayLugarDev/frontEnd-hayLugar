<template>
  <div class="flex flex-col items-center text-center bg-[#1B263B]/70 border border-white/10 rounded-2xl p-6">
    <qrcode-vue :value="token" :size="200" level="H" render-as="svg" class="mb-4" />
    <p class="text-[#B0BEC5] text-sm break-all max-w-xs">{{ token }}</p>
    <button @click="copy" class="mt-4 bg-[#00B4D8] hover:bg-[#06D6A0] text-[#0D1B2A] font-semibold rounded-xl px-5 py-2 transition">
      Copiar Token
    </button>
