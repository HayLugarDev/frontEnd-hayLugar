<template>
    <div class="flex flex-col md:w-1/2 mx-auto p-6 gap-2">
        ...
        <div class="space-y-6 font-normal">
            ...
            <fieldset v-if="price_unit === 'hour'" class="border p-4 rounded-lg">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <DatePicker v-model:value="availabilityStart" type="time" format="HH:mm"
                            placeholder="Hora inicio" class="input-field" />
                    </div>
                    <div>
            ...
            <!-- Días disponibles (si es día) -->
            <div v-if="price_unit === 'day'" class="mt-4">
            ...
            <div v-if="price_unit" class="mt-6 p-4 border rounded-lg bg-gray-50 text-sm">
                ...
                <p>Disponible de {{ availabilityStart }} a {{ availabilityEnd }}</p>
...
const handleNext = () => {
    ...
    // Si es por día o semana/mes, validamos además días o rango
    if (price_unit.value === "day" && availabilityDays.value.length === 0) {
        errorMessage.value = "Debes seleccionar al menos un día de disponibilidad.";
        showErrorModal.value = true;
        return;
    }
