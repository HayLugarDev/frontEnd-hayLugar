<template>
    <div class="flex flex-col md:w-1/2 mx-auto p-6 gap-2">
        <h1 class="text-primary text-4xl font-semibold mb-8">Qué tipo de espacio vas a ofrecer como estacionamiento?
        </h1>
        ...
        <FormOption v-model="type" value="private_parking" title="Estacionamiento o guardería"
            text="Playa de estacionamiento, espacio utilizaco específicamente para guardería de vehículos" />
