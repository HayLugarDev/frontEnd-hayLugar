<template>
  <ul class="flex flex-col divide-y divide-gray-200 text-gray-700 text-3xl md:text-base z-50">
    <li>
      <MobileNotificationButton class="menu-item" />
    </li>
    ...
    <li v-if="user" @click="$emit('navigate', '/quit')" class="menu-item text-red-500 hover:bg-red-100">
      <font-awesome-icon icon="right-from-bracket" /> <span>Cerrar sesión</span>
    </li>
  </ul>
</template>
